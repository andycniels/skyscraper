...
<body>
    <div class="container-fluid">
       <header>
        ...
        <!-- main box info -->
        <div class="row">
            <div class="col-sm-6 hidden-xs hidden-xs box-top-left">
                <img src="img/boxone.jpg" alt="about skyscraper">
            </div>
            <div class="col-sm-6 box-top-right">
                <div class="about-quote">
                    <h2 class="box-headline">ABOUT</h2>
                    <hr class="headline-underline" align="left">
                    <br>
                    <h4><span class="high-text">Skyscraper </span>is a record label and digital music distributor, pioneering the music industry into the digital age<span class="high-text">.</span></h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 box-bottom-left">
                <div>
...
Vis vero nihil philosophia et, at labores abhorreant eum, ex eum sumo malorum. Ad nam tation tempor, nec cu falli phaedrum. Dicit labore ne duo, eos wisi omnesque eu. Ei sententiae elaboraret nam, ei cum vidit appetere voluptatum. Vero ridens detraxit ea vix.
            ...
            <div class="col-sm-6 box-bottom-right">
                <div class="quote-mark">
                    <img src="icons/quote.png" alt="">
                </div>
                <div class="about-quote">
                    <h4>...i give you the mausoleum of all hope and desire. I give it to you, not that you may remember time, but that you might forget it now and then.</h4>
                </div>
                <div class="signature">
                    <img src="icons/placeholder_signature.svg" alt="">
                </div>
                <div class="jakob-ceo">
                    <img src="icons/jakob-ceo.png" alt="">
                </div>
