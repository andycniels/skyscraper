        ...
        <div class="col-md-8 col-lg-push-2">
            ...
            <form action="<?php REQUEST_FILENAME ?>" method="POST">
                <div class="form-group">
                    <?php echo $error; ?>
                    <input type="text" class="form-control" name="street" value="<?php echo $street; ?>" placeholder="Street">
                </div>
                <div class="form-group">
                    <?php echo $error2; ?>
                    <input type="text" class="form-control" name="town" value="<?php echo $town; ?>" placeholder="zip and town">
                </div>
                <div class="form-group">
                    <?php echo $error3; ?>
                    <?php echo $phoneVal; ?>
